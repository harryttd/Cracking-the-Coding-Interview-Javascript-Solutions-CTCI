...
import { BuildOrder as DFS_BuildOrder }  from './DFS/BuildOrder';
import { BuildOrder as EdgeRemoval_BuildOrder } from './Edge-Removal/BuildOrder';

const Classes = [DFS_BuildOrder];

for (const Class of Classes) {

  describe('ch4-q07: Book Solution buildOrder', function() {
